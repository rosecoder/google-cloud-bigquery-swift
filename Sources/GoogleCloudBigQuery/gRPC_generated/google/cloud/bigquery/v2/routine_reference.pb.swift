...
package struct Google_Cloud_Bigquery_V2_RoutineReference: Sendable {
...
extension Google_Cloud_Bigquery_V2_RoutineReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".RoutineReference"
  ...
  package static func ==(lhs: Google_Cloud_Bigquery_V2_RoutineReference, rhs: Google_Cloud_Bigquery_V2_RoutineReference) -> Bool {
