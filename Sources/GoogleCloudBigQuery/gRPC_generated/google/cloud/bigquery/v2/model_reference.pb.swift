...
/// Id path of a model.
package struct Google_Cloud_Bigquery_V2_ModelReference: Sendable {
...
extension Google_Cloud_Bigquery_V2_ModelReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ModelReference"
  ...
  package static func ==(lhs: Google_Cloud_Bigquery_V2_ModelReference, rhs: Google_Cloud_Bigquery_V2_ModelReference) -> Bool {
