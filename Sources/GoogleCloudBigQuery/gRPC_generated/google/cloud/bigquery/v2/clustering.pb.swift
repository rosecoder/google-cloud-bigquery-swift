...
package struct Google_Cloud_Bigquery_V2_Clustering: Sendable {
...
extension Google_Cloud_Bigquery_V2_Clustering: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".Clustering"
  ...
  package static func ==(lhs: Google_Cloud_Bigquery_V2_Clustering, rhs: Google_Cloud_Bigquery_V2_Clustering) -> Bool {
